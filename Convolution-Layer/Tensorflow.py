...
L1 = tf.nn.relu(tf.nn.conv2d(X, W1, strides=[1, 2, 2, 1], padding='VALID') + b1)

L1_flat = tf.reshape(L1, [-1, 12 * 12 * 24])

W2 = tf.Variable(tf.random_uniform([12 * 12 * 24, 512], minval=-0.01, maxval=0.01))
