...
int main() {
	...
	NN.Add(24, 12, 12);
	NN.Add(48, 8, 8)->Activation(Activation::relu);
	NN.Add(48, 4, 4);
	NN.Add(512)->Activation(Activation::relu);
	NN.Add(number_nodes[1])->Activation(Activation::softmax);

	NN.Connect(1, 0, "W,kernel(5x5)")->Initializer(RandomUniform(-0.1, 0.1));
	NN.Connect(2, 1, "P,max");
	NN.Connect(3, 2, "W,kernel(5x5)")->Initializer(RandomUniform(-0.1, 0.1));
	NN.Connect(4, 3, "P,max");
	NN.Connect(5, 4, "W")->Initializer(RandomUniform(-0.01, 0.01));
	NN.Connect(6, 5, "W")->Initializer(RandomUniform(-0.01, 0.01));
