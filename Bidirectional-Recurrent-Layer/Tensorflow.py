...
outputs, states = tf.contrib.cudnn_rnn.CudnnRNNRelu(1, 128, direction='bidirectional', kernel_initializer=tf.keras.initializers.he_normal())(Xt)
outputs = tf.concat([outputs[-1, :, :128], outputs[0, :, 128:]], axis=1)
